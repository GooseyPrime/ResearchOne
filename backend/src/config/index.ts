...
const config = {
  ...
  models: {
    ...
    fallbacks: {
      planner: process.env.PLANNER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      retriever: process.env.RETRIEVER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      reasoner: process.env.REASONER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      skeptic: process.env.SKEPTIC_FALLBACK || 'anthropic/claude-3.7-sonnet',
      synthesizer: process.env.SYNTHESIZER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      verifier: process.env.VERIFIER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      outlineArchitect: process.env.OUTLINE_ARCHITECT_FALLBACK || 'anthropic/claude-3.7-sonnet',
      sectionDrafter: process.env.SECTION_DRAFTER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      internalChallenger: process.env.INTERNAL_CHALLENGER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      coherenceRefiner: process.env.COHERENCE_REFINER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      revisionIntake: process.env.REVISION_INTAKE_FALLBACK || 'anthropic/claude-3.7-sonnet',
      reportLocator: process.env.REPORT_LOCATOR_FALLBACK || 'anthropic/claude-3.7-sonnet',
      changePlanner: process.env.CHANGE_PLANNER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      sectionRewriter: process.env.SECTION_REWRITER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      citationIntegrityChecker: process.env.CITATION_INTEGRITY_CHECKER_FALLBACK || 'anthropic/claude-3.7-sonnet',
      finalRevisionVerifier: process.env.FINAL_REVISION_VERIFIER_FALLBACK || 'anthropic/claude-3.7-sonnet',
    },
  },
