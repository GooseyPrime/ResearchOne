...
export const ENSEMBLE_PRESETS: Record<ResearchObjective, Record<ReasoningModelRole, RoleModelPair>> = {
  ...
  INVESTIGATIVE_SYNTHESIS: mergePreset(BASE_GENERAL, {
    ...
    // Red team: OpenRouter-stable (HF hub ids can fail via OR proxy or require HF_TOKEN + Inference API)
    skeptic: pair(M.r1, M.kimi),
    internal_challenger: pair(M.r1, M.kimi),
  ...
  ANOMALY_CORRELATION: mergePreset(BASE_GENERAL, {
    ...
    skeptic: pair(M.r1, M.kimi),
    internal_challenger: pair(M.kimi, M.r1),
