...
function maybeReadResearchBriefFromUnknown(raw: unknown, fallbackIntent: IntentId): ResearchBrief | undefined {
...
function coercePlanPayload(raw: unknown, intentFallback: IntentId, confFallback: number): PlanPayload {
  ...
  const briefFromPayload = maybeReadResearchBriefFromUnknown(o.researchBrief, id);
