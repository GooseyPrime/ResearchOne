...
function coercePlanPayload(raw: unknown, intentFallback: IntentId, confFallback: number): PlanPayload {
  ...
  const orchestrationProfile = {
    ...
    description: typeof orch.description === 'string' ? orch.description : 'Canonical per-intent orchestration profile.',
  ...
  try {
    ...
    const stub: PlanPayload = {
      ...
      orchestrationProfile: {
        ...
        description: 'Canonical profile will be applied from intent orchestration maps.',
