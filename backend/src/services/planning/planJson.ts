...
function coerceResearchBriefFromUnknown(raw: unknown, fallbackIntent: IntentId): ResearchBrief | undefined {
...
function coercePlanPayload(raw: unknown, intentFallback: IntentId, confFallback: number): PlanPayload {
  ...
  const briefFromPayload = coerceResearchBriefFromUnknown(o.researchBrief, id);
