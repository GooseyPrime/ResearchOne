-- Migration 048: Idempotent repair — ensure v_dossier uses security_invoker (PR #127 / tenant isolation).
-- Recreates canonical definition from 047 so late 035/036 view replaces cannot drop invoker.
