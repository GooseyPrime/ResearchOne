...
/** Copy preset — revision fetches URLs synchronously on submit; spinoff uses async research ingest. */
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-stretch gap-2">
        <input
          type="url"
          inputMode="url"
          placeholder={mode === 'revision' ? 'Paste a URL to fetch on submit (https://…)' : 'Paste a URL to ingest (https://…)'}
      ...
      {resolvedDescription ? <p className="text-xs text-slate-500 -mt-1">{resolvedDescription}</p> : null}
