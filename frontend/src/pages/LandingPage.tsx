...
[speculation]      Mechanism via autophagy upregulation is plausible
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <PricingCard title="Pro" details="$29/mo or $290/yr — 25 reports/mo — All 5 modes, priority queue" cta="Subscribe" to="/sign-up?tier=pro" featured />
          <PricingCard title="BYOK" details="$29/mo — All 5 modes, unlimited runs — You bring OpenRouter keys" cta="Configure keys" to="/byok" />
